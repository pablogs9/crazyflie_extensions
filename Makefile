...
EXTERNAL_TRANSPORT_HEADER = $(SRC_DIR)/crazyflie_transport.h
EXTERNAL_TRANSPORT =$(SRC_DIR)/crazyflie_transport.c
...
libmicroxrcedds: arm_toolchain.cmake
	...
	cp $(PROJECTFOLDER)/Micro-XRCE-DDS-Client/build/install/lib/libmicroxrcedds_client.a $(PROJECTFOLDER)/bin/	DEBUG ?= 1
